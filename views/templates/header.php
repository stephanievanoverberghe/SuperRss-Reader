                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav d-flex align-self-center justify-content-around mb-2 mb-lg-0 mx-auto">
                        <li class="nav-item px-lg-4 px-xxl-5">
                            <a class="nav-link mx-2 mx-xxl-5" href='../../controllers/pages-controller.php?sujet=1'><?= $subjectOne ?? $subjectDefaultOne ?></a>
                        </li>
                        <li class="nav-item px-lg-4 px-xxl-5">
                            <a class="nav-link mx-2 mx-xxl-5" href="../../controllers/pages-controller.php?sujet=2"><?= $subjectTwo ?? $subjectDefaultTwo ?></a>
                        </li>
                        <li class="nav-item px-lg-4 px-xxl-5">
                            <a class="nav-link mx-2 mx-xxl-5" href="../../controllers/pages-controller.php?sujet=3"><?= $subjectThree ?? $subjectDefaultThree ?></a>
                        </li>
                    </ul>
